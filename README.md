...
- **Operating System**: Linux (Ubuntu/Debian-based or other distros)
- **Git**: Version control [Download & Install](https://git-scm.com/downloads)
- **Flutter SDK**: Latest stable release [Install Guide](https://docs.flutter.dev/get-started/install/linux/desktop)
- **IDE (choose one)**:
    - **VS Code**:
...
2. **Locate the `rosUrl` constant** and update it based on your setup:
    - **Local Machine**:
        ```dart
        const String rosUrl = 'ws://127.0.0.1:9090';
        ```
    - **Different Machine and same network**: 
