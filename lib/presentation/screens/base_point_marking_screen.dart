...
import 'package:toastification/toastification.dart'; // <-- Make sure this is added
...
class BasePointMarkingScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _BasePointMarkingScreenState();
}
                      ...
                      child: Center(
                        child: FittedBox(
                          ...
                          child: ButtonWidget(
                            ...
                            onPressed: () {
                              print('User clicked "I am at the Base Point" button');
                              showDialog(
                                context: context,
                                builder: (context) => SaveStartingPointDialog(
                                  onConfirmed: () {
                                    print('User confirmed saving the starting point');
                                    ...
                                    Future.microtask(() {
                                      toastification.show(
                                        ...
                                        description: const Text("Base Point saved successfully!"),
