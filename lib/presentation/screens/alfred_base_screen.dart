...
//
//
// // Updated provider for managing the selected table state
// final selectedTableProvider = StateNotifierProvider<SelectedTableNotifier, String?>((ref) {
//   return SelectedTableNotifier();
// });
//
// class SelectedTableNotifier extends StateNotifier<String?> {
//   SelectedTableNotifier() : super(null);
//
//   void selectTable(int table) {
//     state = table.toString();
//   }
// }
//
// class BaseScreen extends ConsumerWidget {
...
//                         crossAxisAlignment: CrossAxisAlignment.start,
//                         children: [
//                           // Align "Select Table" to be in the same vertical line as "Go to Table"
//                           Padding(
//                             padding: const EdgeInsets.only(top: 50, bottom: 30),
//                             child: SizedBox(
//                               width: 524, // Match the width of "Go to Table"
//                               child: Center(
//                                 child: Text(
//                                   "Select Table",
...
//                                 child: ElevatedButton(
//                                   onPressed: () {
//                                     ref.read(selectedTableProvider.notifier).selectTable(tables[index]);
//                                   },
//                                   style: ElevatedButton.styleFrom(
//                                     backgroundColor: selectedTable == tables[index]
//                                         ? Colors.black
//                                         : Colors.white,
//                                     foregroundColor: selectedTable == tables[index]
//                                         ? Colors.white
//                                         : Colors.black,
...
//                       );
//                       // context.go(
//                       //   '${AlfredConstants.routeTableMoveScreen}/${ref.read(selectedTableProvider)}',
//                       //
//                       // );
//                       context.go(
//                         '${AlfredConstants.routeTableMoveScreen}/${ref.read(selectedTableProvider)}',
