                ...
                children: [
                  _buildChecklistCard(
                    ...
                    onChanged: (val) {
                      ...
                      print('Task 1 - Take Alfred to the Start point: ${_task1Completed ? "Completed" : "Not Completed"}');
                    },
                    isBlueBorder: true,
                  ),
                  _buildChecklistCard(
                    ...
                    onChanged: (val) {
                      ...
                      print('Task 2 - Remove all wires or cables from the path: ${_task2Completed ? "Completed" : "Not Completed"}');
                    },
                  ),
                  _buildChecklistCard(
                    ...
                    onChanged: (val) {
                      ...
                      print('Task 3 - Ensure the floor is clear of obstacles: ${_task3Completed ? "Completed" : "Not Completed"}');
                    },
                  ),
                ],
              ),
