...
//   Widget build(BuildContext context, WidgetRef ref) {
//     final isTraining = ref.watch(isTrainingProvider);
//     // Use the passed isSelected parameter or calculate from provider
//     final shouldBeSelected = isSelected || (!isDashed && ref.watch(selectedTableProvider) == tableNumber);
//     final isDisabled = isTraining && !shouldBeSelected;
//
//     return SizedBox(
//       width: 138,
//       height: 60,
...
//   @override
//   Widget build(BuildContext context, WidgetRef ref) {
//     // Remove the local isSelected calculation since we're passing it now
//     return SizedBox(
//       width: 138,
//       height: 60,
//       child: isDashed
...
//     final isSelected = !isDashed && selectedTable == tableNumber;
//
//     return SizedBox(
//       width: 138, // Fixed width
